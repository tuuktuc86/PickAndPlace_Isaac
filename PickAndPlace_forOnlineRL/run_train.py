...
cfg["experiment"]["directory"] = "runs/torch/Isaac-PickAndPlace-Franka-v3" #2 for lift, 3 for reaching
...
# agent.load("/fail-detect_acss/runs/torch/Isaac-PickAndPlace-Franka-v2/25-09-24_03-26-39-092765_PPO_deltaRel(set_origin)/checkpoints/best_agent.pt")
